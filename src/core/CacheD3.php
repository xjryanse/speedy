...
class CacheD3 {
    ...
    public function set($key, $value, $expire = 0) {
        ...
        if ($expire > 0) {
            return Redis::d3Inst()->setex($keyN, $expire, $cV);
        }
        return Redis::d3Inst()->set($keyN, $cV);
    }
    ...
    public function exists($key) {
        $keyN = self::preFix() . $key;
        return Redis::d3Inst()->exists($keyN);
    }
